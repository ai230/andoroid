...
public class MainActivity extends AppCompatActivity implements RecipeAdapter.ListItemClickListener{
    ...
    public void prepareRecipeData(){
        ...
        recipeList.add(recipe);
        recipe = new Recipe("recipe_6", "Gary's Stuffed Mushrooms", "Dry stuffing mix is the key to these wonderful stuffed mushrooms!", "http://allrecipes.com/recipe/24174/garys-stuffed-mushrooms/?internalSource=previously%20viewed&referringContentType=home%20page&clickId=cardslot%205");
        recipeList.add(recipe);
        recipe = new Recipe("recipe_7", "Crispy Orange Beef", "A delicious crispy and sweet, yet mildly spiced beef stir-fry recipe. Great served with steamed rice and broccoli.", "http://allrecipes.com/recipe/57966/crispy-orange-beef/?internalSource=previously%20viewed&referringContentType=home%20page&clickId=cardslot%2041");
        recipeList.add(recipe);
        recipe = new Recipe("recipe_8", "Chipotle Beef Tostadas", "Tostadas are layered with spicy chipotle beef, sour cream, and shredded cheese for a flavorful and Mexican-inspired meal.", "http://allrecipes.com/recipe/233762/chipotle-beef-tostadas/?internalSource=previously%20viewed&referringContentType=home%20page&clickId=cardslot%2042");
        recipeList.add(recipe);
        recipe = new Recipe("recipe_9", "Chinese Chicken Fried Rice I", "Chicken stir-fried with a colorfull array of vegetables and a bounty of rice with a scramble of eggs running throughout.", "http://allrecipes.com/recipe/17161/chinese-chicken-fried-rice-i/?internalSource=previously%20viewed&referringContentType=home%20page&clickId=cardslot%2061");
        recipeList.add(recipe);
        recipe = new Recipe("recipe_10", "Smoked Andouille Quesadilla", "These crispy shrimp are rolled in a coconut beer batter before frying. For dipping sauce, I use orange marmalade, mustard and horseradish mixed to taste.", "http://allrecipes.com/recipe/241211/smoked-andouille-quesadilla/?internalSource=previously%20viewed&referringContentType=home%20page&clickId=cardslot%2014");
        recipeList.add(recipe);
    }
