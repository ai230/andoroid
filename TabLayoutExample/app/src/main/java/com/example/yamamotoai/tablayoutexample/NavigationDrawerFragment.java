...
//import pt.forkit.androidlx_2014.ui.adapter.MenuAdapter;
...
//        ArrayList<pt.forkit.androidlx_2014.domain.Menu> items = new ArrayList<pt.forkit.androidlx_2014.domain.Menu>();
//        items.add(new pt.forkit.androidlx_2014.domain.Menu("Search", R.drawable.search));
//        items.add(new pt.forkit.androidlx_2014.domain.Menu("My Music", R.drawable.sound));
...
//        if (mLvMenu != null) {
//            mLvMenu.setItemChecked(position, true);
